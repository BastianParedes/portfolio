            ...
            <div className={styles['main']}>
                <div className={styles['main-left']}>
                    ...
                    <button className={styles['button-cv']}>
                        <a className={styles['button-cv__a']} href="https://drive.google.com/file/d/1LheHpim4QsBKLe6kxYD1OMggrRW8DLWl/view?usp=sharing" target='_blank' rel='noreferrer noopener'>Ver currículum</a>
                    </button>
                </div>
